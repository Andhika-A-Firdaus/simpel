  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
         <span class="navbar-brand"><strong style="font-family: verdana;">SIMPEL</strong></span>
    ...
    <div class="container">
	  ...
	  <div class="span12 well well-sm">
		<h4 style="font-weight: bold">SIMPEL (Sistem Persuratan Elektronik) by Andhika A. Firdaus </h4>
		<h6>&copy;  Januari 2015. Waktu Eksekusi : {elapsed_time}, Penggunaan Memori : {memory_usage}</h6>
	  </div>
